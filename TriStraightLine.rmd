...
# つぶれ六角プリズム
tsubu <- rbind(c(1,2,3),c(1,3,4),c(1,4,5),c(1,5,6),c(1,6,7),c(1,7,2),c(2,8,3),c(3,9,4),c(4,10,5),c(5,11,6),c(6,12,7),c(7,13,2),c(3,8,9),c(4,9,10),c(5,10,11),c(6,11,12),c(13,9,8),c(13,10,9),c(13,11,10),c(13,12,11),c(13,8,2),c(13,7,12))
