...
```{r}
bunny <- my.read.obj("bunny_1k.obj")
```
```{}
open3d()
...
A <- adj.mat/max(adj.mat)*pi
A <- cos(A)
A.w <- adj.mat.w/max(adj.mat.w)*pi
A.w <- cos(A.w)
```
```{r}
ev <- eigen(A)
...
fk <- 1
Fiedler.vec <- ev[[2]][,fk]
Fiedler.vec.w <- ev.w[[2]][,fk]

n.st <- 3
cuts <- my.stripe(Fiedler.vec,n.st)+2
cuts.w <- my.stripe(Fiedler.vec.w,n.st)+1
...
```{r}
library(tsne)
tsneout <- tsne(as.dist(dist.mat),k=3)
```
...
```{r}
n.st <- 2
cuts.tsne1 <- my.stripe(tsneout[,1],n.st)+1
cuts.tsne2 <- my.stripe(tsneout[,2],n.st)+1
cuts.tsne3 <- my.stripe(tsneout[,3],n.st)+1
open3d()
plot3d(bunny[[3]][, 1], bunny[[3]][, 2], bunny[[3]][, 3])
spheres3d(bunny[[3]][, 1], bunny[[3]][, 2], bunny[[3]][, 3],radius=0.01,color=cuts.tsne1)

open3d()
plot3d(bunny[[3]][, 1], bunny[[3]][, 2], bunny[[3]][, 3])
spheres3d(bunny[[3]][, 1], bunny[[3]][, 2], bunny[[3]][, 3],radius=0.01,color=cuts.tsne2)

open3d()
plot3d(bunny[[3]][, 1], bunny[[3]][, 2], bunny[[3]][, 3])
spheres3d(bunny[[3]][, 1], bunny[[3]][, 2], bunny[[3]][, 3],radius=0.01,color=cuts.tsne3)

open3d()
plot3d(bunny[[3]][, 1], bunny[[3]][, 2], bunny[[3]][, 3])
spheres3d(bunny[[3]][, 1], bunny[[3]][, 2], bunny[[3]][, 3],radius=0.01,color=(cuts.tsne1-1) + (cuts.tsne2-2)*2 + (cuts.tsne3-2)*4)
```
